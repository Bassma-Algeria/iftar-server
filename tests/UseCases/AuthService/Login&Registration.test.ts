...
describe('Registration & Login Use cases', () => {
    ...
    it('new Restaurant Owner should not be able to register with an existing email', async () => {
    ...
    it('new Restaurant Owner should not be able to register with an existing phoneNumber', async () => {
        await authService.register(registrationBody);
        await expect(
    ...
    it('should not be able to login with none exsisting email', async () => {
        await expect(
            authService.login(registrationBody),
    ...
    it('should login normally when trying with an email with uppercase letters, or with some spaces in the left and right', async () => {
        await authService.register(registrationBody);
    ...
    it('the password to login should be case sensitive', async () => {
        await authService.register(registrationBody);

        await expect(
            authService.login({
                ...registrationBody,
                password: registrationBody.password.toUpperCase(),
            }),
